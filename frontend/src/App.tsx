...
function App() {
  ...
  return (
    <div className="min-h-screen bg-ink text-ivory relative overflow-x-hidden">
      <BackgroundArt />
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col gap-4 md:gap-10 px-4 pt-0 pb-3 md:py-10 md:px-10 overflow-x-hidden min-w-0">
        <header className="bg-ink md:bg-transparent">
              ...
              {navLinks.map((link, index) => (
                ...
                >
                  <NavLink
                    to={link.path}
                    className={({ isActive }) =>
                      `border px-3 py-2 md:px-4 md:py-2 transition block text-[0.7rem] md:text-xs text-center md:whitespace-nowrap ${
                        isActive
        ...
        <main className="flex-1 pb-0 md:pb-16">
